		...
		<div class="login_wrap">
			<div class="w">
				<div class="login_form">
						...
						<div class="form">
							<form>
								<div class="item item_fore1">
									...
									<input type="text" id="loginname" class="itxt" name="loginname" autocomplete="new-password" placeholder="用户名" v-model="form.loginname" @blur="loginnameblur($event)" @focus="loginnamefocus($event)">
									<span class="clear_btn divnone" id="loginname_clear_btn" @mousedown="loginnameclear"></span>
								</div>
								<div class="item item_fore2">
									...
									<span class="clear_btn divnone" id="loginpwd_clear_btn" @mousedown="loginpwdclear"></span>
								</div>
					...
					<div class="qrcode_login divnone"></div>
					<div class="coagent">
						<ul>
							<li>
	...
	export default{
		...
		methods:{
			...
			loginnameblur($event){
				...
				loginnameclearbtn.classList.add("divnone");//隐藏叉号
			},
			loginpwdfocus($event){
